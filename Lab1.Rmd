...
My strategy with git depends on the project - If I am working with others then I commit every time I stop working. I only pushed a few times during this project because I was not worried about information getting lost and since it was only one file to track. 
